  ...
  render() {
    ...
    return (
      <div className="layout">
        ...
        <div className="layout__footer">
          <div className="footer_panel">
            <div id="footer">
              ...
              <dl>
                <dt>Разное</dt>
                <dd><Link to="https://appmetrica.yandex.com/serve/240693928167260216?utm_source=HH_desktop&utm_medium=button&utm_campaign=appiOS" target="_blank" onClick={ga('footer', 'links', 'ios_app')}>iOS приложение</Link></dd>
                <dd>
                  <Link to="https://appmetrica.yandex.com/serve/745097116363323173?id=ru.habrahabr&utm_source=HH_desktop&utm_medium=button&utm_campaign=appAndroid" target="_blank"
                    onClick={ga('footer', 'links', 'android_app')}>Android приложение</Link>
                </dd>
                <dd><Link to="https://special.habrahabr.ru/hello_startup/habrahabr/" target="_blank">Помощь стартапам</Link></dd>
              </dl>
              <div className="copyright">
                <div className="about">
                  ...
                  <div className="social_accounts">
                    <Link to="https://twitter.com/habrahabr" target="_blank" onClick={ga('footer', 'Social_icons', 'twitter')}>
                    ...
                    <Link to="https://www.facebook.com/habrahabr.ru" target="_blank" onClick={ga('footer', 'Social_icons', 'facebook')}>
                    ...
                    <Link to="https://vk.com/habr" target="_blank" onClick={ga('footer', 'Social_icons', 'vkontakte')}>
                    ...
                    <Link to="https://telegram.me/habr_ru" target="_blank" onClick={ga('footer', 'Social_icons', 'telegram')}>
        ...
        <Link to="#" className="layout__elevator hidden" id="scroll_to_top" title="Наверх" onClick={ga('navigation_button', 'down', window.location.href)}>
