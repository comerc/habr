    ...
    <div className="main-navbar__section main-navbar__section_left" data-style="display: flex;">
      ...
      <ul className="nav-links" id="navbar-links">
        <li className="nav-links__item">
          <Link to="/" className="nav-links__item-link ">Публикации</Link>
        </li>
        <li className="nav-links__item">
          <Link to="/hubs/" className="nav-links__item-link ">Хабы</Link>
        </li>
        <li className="nav-links__item">
          <Link to="/companies/" className="nav-links__item-link ">Компании</Link>
        </li>
        <li className="nav-links__item">
          <Link to="/users/" className="nav-links__item-link ">Пользователи</Link>
        </li>
        <li className="nav-links__item">
          <Link to="/sandbox/" className="nav-links__item-link ">Песочница</Link>
        </li>
      </ul>
